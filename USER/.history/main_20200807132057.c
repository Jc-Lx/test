...
//主函数//
 ...
 {  
    ...
    RTC_Init();                                        //RTC初始化//
    OLED_Init();  
    OLED_ShowString(0,0,"DesignBy:JC-LX",16);  
 ...
 while(1)
    {   
        if(t!=calendar.sec)
        {
         ...
         OLED_ShowNum(10,48,calendar.hour,2,24);
         OLED_ShowChar(20,48,':',16,1);
         OLED_ShowNum(40,48,calendar.min,2,24);
         OLED_ShowChar(50,48,':',16,1);
         OLED_ShowNum(80,48,calendar.sec,2,24);
