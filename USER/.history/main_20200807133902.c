...
//主函数//
 ...
 {  
    ...
    RTC_Init();                                        //RTC初始化//
    OLED_Init();  
    OLED_ShowString(0,0,"Design:LX",16);  
 ...
 while(1)
    {   
        if(t!=calendar.sec)
        {
         ...
         OLED_ShowChar(38,24,'/',16,1);
         OLED_ShowNum(53,24,calendar.w_month,2,16);
         OLED_ShowChar(70,24,'/',16,1);
         OLED_ShowNum(78,24,calendar.w_date,2,16);

         OLED_ShowNum(0,40,calendar.hour,2,24);
         OLED_ShowChar(20,40,':',16,1);
         OLED_ShowNum(50,40,calendar.min,2,24);
         OLED_ShowChar(70,40,':',16,1);
