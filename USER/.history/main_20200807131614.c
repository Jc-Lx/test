 ...
 while(1)
    {   
        if(t!=calendar.sec)
        {
         ...
         OLED_ShowNum(10,38,calendar.hour,2,24);
         OLED_ShowChar(20,38,':',16,1);
         OLED_ShowNum(40,38,calendar.min,2,24);
         OLED_ShowChar(50,38,':',16,1);
         OLED_ShowNum(80,38,calendar.sec,2,24);
