 ...
 while(1)
    {   
        if(t!=calendar.sec)
        {
         ...
         {
            case 0:OLED_ShowString(74,45,"sun",16);break;
            case 1:OLED_ShowString(74,45,"mon",16);break;
            case 2:OLED_ShowString(74,45,"tue",16);break;
            case 3:OLED_ShowString(74,45,"wed",16);break;
            case 4:OLED_ShowString(74,45,"thu",16);break;
            case 5:OLED_ShowString(74,45,"fri",16);break;
            case 6:OLED_ShowString(74,45,"sat",16);break;
         }
         OLED_Refresh_Gram();
